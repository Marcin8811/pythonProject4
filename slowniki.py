...
przykladowy_slownik['kolejny klucz'] = 'jego wartość'
print(przykladowy_slownik)
...
przykladowy_slownik['klucz'] = 'prĻba dodania takiego samego klucza'
print(przykladowy_slownik)
...
przykladowy_slownik['klucz będący listą'] = [234, 'sdfsdf', 324.6, False, {'r' : 345, 'h' : 'dsfds', 1 : 23423}]
print(przykladowy_slownik)
